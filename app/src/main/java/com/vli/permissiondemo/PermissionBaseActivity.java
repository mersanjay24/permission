...
public abstract class PermissionBaseActivity extends AppCompatActivity implements ActivityCompat
        ...
        if (requestCode == REQUEST_PERMISSION_SETTING) {
            ...
            if (permissionCallBack != null) {
                if (!updateAllPermissionStatusAndCheckIfNotGrantedOneIsExists()) {
                    ...
                    permissionCallBack.onPermissionsDenied(PermissionUtils.convertListToArray
    ...
    public void askForPermission(String permissions, boolean sticky, PermissionCallBack
        ...
        initialize(new String[]{permissions}, null, sticky,
                permissionGranted);
        checkPermissionStuff();
    ...
    private String messageSwitcherForToast() {
        return customMessage == null ? PermissionUtils.generatePermissionMessage(PermissionUtils.convertListToArray(remainedPermissionsList)) : customMessage;
    }
    ...
    private void checkPermissionStuff() {
        ...
        if (Build.VERSION.SDK_INT < 23 || updateAllPermissionStatusAndCheckIfNotGrantedOneIsExists()) {
            ...
            if (shouldShowRequestPermissionRationaleForAll()) {
                ...
                showPermissionDialog(PermissionUtils.convertListToArray(remainedPermissionsList));
